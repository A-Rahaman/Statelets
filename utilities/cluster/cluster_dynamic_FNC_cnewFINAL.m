...
for ii = 1:Nwin
    rFdyn(:,ii,:) =  squeeze(Fdyn(:,ii,:)) - (mdynUNI.stats{1}.X(:,[ 3:8 10])*mdynUNI.stats{1}.B( [3:8 10],:));
end
[pth fnm ]= fileparts(inname);
...
% 
 save(fullfile(fileparts(inname), ['FNC_group_clusters_k2_' num2str(k2) 'scrubbed_cnew_resid1model']), 'SPflat', 'IDXp','Cp');
% load(fullfile(fileparts(inname), ['FNC_group_clusters_k2_' num2str(k2) 'scrubbed_cnew']), 'SPflat', 'IDXp','Cp');
G = figure('Color', 'w', 'Name', ['FNC_group_clusters_k' num2str(k2) 'scrubbed_cnew_resid1model'], 'Position', CPOS);
for ii = 1:k2, 
    subplot(1,k2,ii);
...
SPflat2 = cell2mat(SP(sublist(floor(M/2)+1:end)));
 ...
 save(fullfile(fileparts(inname), ['FNC_half1_clusters_k2_' num2str(k2) 'scrubbed_cnew_resid1model']), 'SPflat1', 'IDXp1','Cp1', 'sublist');
...
save(fullfile(fileparts(inname), ['FNC_half2_clusters_k2_' num2str(k2) 'scrubbed_cnew_resid1model']), 'SPflat2', 'IDXp2','Cp2', 'sublist');
%load(fullfile(fileparts(inname), ['FNC_half2_clusters_k2_' num2str(k2) 'scrubbed_cnew']), 'SPflat2', 'IDXp2','Cp2', 'sublist');


G = figure('Color', 'w', 'Name', ['FNC_halfgroup_clusters_k' num2str(k2) 'scrubbed_cnew_resid1model'], 'Position', CPOS);
for ii = 1:k2,
    subplot(2,k2,ii);
...
for k2 = 2:9
    ...
    save(fullfile(fileparts(inname), ['FNC_HC_clusters_k2_' num2str(k2) '_scrubbed_cnew_resid1model']), 'SPflatHC', 'IDXp1','Cp1', 'HCid');
    
    [IDXp2, Cp2, SUMDp2, Dp2] = kmeans(SPflatSZ, k2, 'distance', dmethod, 'Replicates', 1, 'MaxIter', 150, 'Display', 'iter', 'empty', 'drop', 'Start', Cp);

    save(fullfile(fileparts(inname), ['FNC_SZ_clusters_k2_' num2str(k2) '_scrubbed_cnew_resid1model']), 'SPflatSZ', 'IDXp2','Cp2', 'SZid');
    %load(fullfile(fileparts(inname), ['FNC_HC_clusters_k2_' num2str(k2) '_scrubbed_cnew_resid1model']), 'SPflatHC', 'IDXp1','Cp1', 'HCid');
    %load(fullfile(fileparts(inname), ['FNC_SZ_clusters_k2_' num2str(k2) '_scrubbed_cnew_resid1model']), 'SPflatSZ', 'IDXp2','Cp2', 'SZid');
    G = figure('Color', 'w', 'Name', ['FNC_DIAGgroup_clusters_k' num2str(k2) '_scrubbed_cnew_resid1model'], 'Position', CPOS);
    for ii = 1:k2,
        subplot(2,k2,ii);
...
Fdynflat = reshape(rFdyn, M*Nwin , size(Fdyn,3));
for k2 = 2:9 
     ...
     aIND = aIND';
%     
     save(fullfile(fileparts(inname), ['FNC_clusters_all_k' num2str(k2) '_scrubbed_cnew_resid1model']), 'IDXall', 'Call')
     save(fullfile(fileparts(inname), ['FNC_all_states_k' num2str(k2) '_scrubbed_cnew_resid1model']), 'aIND')
%    load(fullfile(fileparts(inname), ['FNC_clusters_all_k' num2str(k2) '_scrubbed_cnew_resid1model']), 'IDXall', 'Call')
    G = figure('Color', 'w', 'Name', ['FNC_clusters_all_k' num2str(k2) '_scrubbed_cnew_resid1model'], 'Position', CPOS);
    for ii = 1:k2,
        subplot(1,k2,ii);
    ...
    H = figure('Color', 'w', 'Name', ['FNC_clusters_occurrence_k' num2str(k2) '_scrubbed_cnew_resid1model'], 'Position', CPOS);
    for ii = 1:k2,
        subplot(1,k2,ii);
        for bb = 1:100
...
for k2 = 2:9
    ...
    save(fullfile(fileparts(inname), ['FNC_clusters_allone_HCSZ_k' num2str(k2) '_scrubbed_cnew_resid1model']), 'IDXallone','aINDallone', 'Callone','SUMDallone','Dallone')
%     
%    load(fullfile(fileparts(inname), ['FNC_clusters_allone_HCSZ_k' num2str(k2) '_scrubbed_cnew_resid1model']), 'IDXallone','aINDallone', 'Callone','SUMDallone','Dallone');
    aINDallone_SZ = aINDallone(SZid,:);
    aINDallone_HC = aINDallone(HCid,:);
    aINDHC = aINDallone_HC';
    aINDSZ = aINDallone_SZ';
    G = figure('Color', 'w', 'Name', ['FNC_clusters_allone_HCSZ_k' num2str(k2) '_scrubbed_cnew_resid1model'], 'Position', CPOS);
    for ii = 1:k2,
        subplot(2,k2,ii);
    ...
    H = figure('Color', 'w', 'Name', ['FNC_clusters_allone_occurrenceHCSZ_k' num2str(k2) '_scrubbed_cnew_resid1model'], 'Position', CPOS);
    for ii = 1:k2,
        subplot(2,k2,ii);
        for bb = 1:100
            pickME1 = ceil(nHC*rand(nHC,1));
...
save(fullfile(fileparts(inname), ['mn_mdn_FNC_clusters_alloneByDiag_kall_scrubbed_cnew_resid1model']), 'mean_Kwin_allHC', 'mean_Kwin_allSZ' , 'mdn_Kwin_allHC', 'mdn_Kwin_allSZ','nS_Kwin_allHC','nS_Kwin_allSZ');
% stats
%load(fullfile(fileparts(inname), ['mn_mdn_FNC_clusters_alloneByDiag_kall_scrubbed_cnew_resid1model']), 'mean_Kwin_allHC', 'mean_Kwin_allSZ' , 'mdn_Kwin_allHC', 'mdn_Kwin_allSZ','nS_Kwin_allHC','nS_Kwin_allSZ');
for k2 = 3:8
    mx = zeros(1,k2);mdx = mx;
    for jj = 1:k2
       [hh pp ci tst] = ttest2(mean_Kwin_allHC{k2-2,jj} ,mean_Kwin_allSZ{k2-2,jj});
    ...
    G1 = figure('Color', 'w', 'Name', ['FNC_clustersMNGroupDiff_alloneSubj_k' num2str(k2) '_scrubbed_cnewRev_resid1model'], 'Position', CPOSn);
    for jj = 1:k2
  ...
  %  close(G1)
    ...
    G2 = figure('Color', 'w', 'Name', ['FNC_clustersMDNGroupDiff_alloneSubj_k' num2str(k2) '_scrubbed_cnewRev_resid1model'], 'Position', CPOSn);
    for jj = 1:k2
