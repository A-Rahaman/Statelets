#
# This script runs tSNE on all local motifs (pairwise)of SZ group
# Visualize subgroups of motifs in HC dynamic. 
# 
#
# Implementation of t-SNE in Python. The implementation was tested on Python
# 2.7.10, and it requires a working installation of NumPy. 
# The results of this example, a working installation of matplotlib is required.
#
...
if __name__ == "__main__":
			...
			# Change the directory D2 for appropriate EMD matrix for SZ group 
            #D2 = scipy.io.loadmat('/Users/mrahaman1/Documents/Statelet_V2/fResults/subWISEEMDMats/EMD_of_sub_' + str(j) + '.mat');
            D2 = scipy.io.loadmat('/Users/mrahaman1/Documents/Statelet_V2/StateletFramework/results/GroupwiseResults/group_wise_EMD_SZ.mat');
            #D2 = scipy.io.loadmat('/Users/mrahaman1/Documents/Statelet_V2/fResults/SZsubEMD.mat');
            ...
            #f = open("/Users/mrahaman1/Documents/Statelet_V2/fResults/tSNEcoord_SZ" +".txt", "w")
            f = open("/Users/mrahaman1/Documents/Statelet_V2/StateletFramework/results/GroupwiseResults/tSNEcoord_SZ" +".txt", "w")
